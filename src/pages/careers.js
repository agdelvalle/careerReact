...
// import { CareersList } from "../components/list";
import { CareersForm } from "../components/form";
...
export const DisplayAll = () => {
    ...
    const addListing = (title, level, dept, summary, headcount) => {
      const jobCount = jobs.length + 1 
      const ID = "random-id-"+ jobCount
      // console.log(ID)
                                ...
                                <div className="px-4 py-4 flex items-center sm:px-6">
                                  ...
                                  >
                                    <button
                                      ...
                                      onClick={ () => {
                                        const newJobs = [...jobs];
                                        newJobs.splice(jobs.indexOf(job), 1);
                                        setJobs(newJobs);
                                        }
                                      }
                                    >
